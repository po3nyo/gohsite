...
<head>
    ...
    * {
    ...
    function check_id() {
        ...
        if (userid) {
            url = "./member/check.php?userid=" + userid;
    ...
    function check_nik() {
        ...
        if (usernic) {
            url = "./member/check.php?usernic=" + usernic;
            window.open(url, "chkid", "width=300,height=100");
        } else {
            alert("닉네임을 입력하세요");
        }
...
<body>
    <div id="sign_up_box">
        ...
        <form class="" action="./member/sign_up_search.php" method="post" id="sign">
            <table>
                <tr>
                    <td>아이디</td>
                    <td>
                ...
                <tr>
			        <td rowspan="2"><img src="./captcha.php?date=<?echo date('h:i:s')?>"></td><td><font size="2"; color ="red">화면에 보이는 문구를 입력하세요</font></td>
                </tr >  
                <tr>    
            ...
            <button id="sign_up_button" type="button" name="button" align="right"
                onclick="passwordCheck()">회원가입</button>
